...
def teleop(robot_side, init_node = False):
...
if __name__=='__main__':
    ...
    # publisher = MujocoPublisher(model, data, host="192.168.0.143")
    ...
    with mujoco.viewer.launch_passive(
        ...
        left_robot = teleop("left", True)
        right_robot = teleop("right", False)
        ...
        while viewer.is_running():
            ...
            data.ctrl[left_gripper_actuator] = left_robot.dxl.joint_states.position[6]
            data.ctrl[right_gripper_actuator] = right_robot.dxl.joint_states.position[6]
